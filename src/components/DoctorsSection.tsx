...
import doctorMale from "@/assets/Sir[1].jpg";
import doctorFemale from "@/assets/Mam[2].jpg";
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {/* Name overlay */}
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 bg-black/60 text-white px-4 py-2 rounded-lg text-lg font-semibold">
          Dr. Patil
        </div>
      </motion.div>
      ...
      <AnimatePresence>
        {step === "text" && (
          ...
          >
            <p className="max-w-6xl text-4xl md:text-2xl text-muted-foreground font-accent leading-relaxed text-center">
