    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-center h-full p-4 text-center">
        <div className="space-y-3 transform translate-y-6 group-hover:translate-y-0 transition-all duration-500 ease-out">
          <h3 className="font-accent text-2xl md:text-3xl font-medium text-white group-hover:drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] group-hover:scale-105 transition-all duration-500">
            {service.title}
          </h3>
          ...
          {service.list ? (
            <motion.ul
              ...
              className="text-white font-accent text-sm md:text-base leading-snug space-y-1 group-hover:drop-shadow-[0_1px_4px_rgba(0,0,0,0.6)]"
            ...
            service.description && (
              <motion.p
                initial={{ opacity: 0, y: 10 }}
                whileHover={{ opacity: 1, y: 0 }}
                className="text-white font-accent text-sm md:text-base leading-snug group-hover:drop-shadow-[0_1px_4px_rgba(0,0,0,0.6)]"
              >
                {service.description}
              </motion.p>
            )
  ...
  return (
    <section id="services" className="w-full min-h-screen mt-16 md:mt-24">
      ...
      <div className="text-center mb-12 space-y-4">
        <h1 className="font-accent text-3xl md:text-4xl font-bold text-foreground">
          Find Your Procedure
        </h1>
        <h2 className="font-accent text-2xl md:text-3xl font-semibold text-foreground">
          Aesthetic Procedures & Non-Surgical Enhancement In Chh.Sambhajinagar
        </h2>
        <p className="font-accent text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
